      ...
      <div className="landing-infoWrapper">
        ...
        <div className="landing-textAndContactWrapper">
          <p>
            ...
            Bennet is a comedy filmmaker based in Los Angeles and a Seattle boy
            at heart. He parlayed his award-winning viral shorts into directing
            for <span className="landing-emphasis">
              Jimmy Kimmel Live!
            </span>, <span className="landing-emphasis">Nickelodeon</span>, and
            serving as an EP + director for 10ish seasons of very funny episodic
            series on streaming platforms that don’t exist anymore (may they
            rest in peace). He also brings his EP skills to commercials, writing
            ...
            too many. Oh yeah, and he’s a WGA-nominated writer. Nice.
          </p>
          <Link to="/contact">
            <Button
              sx={{
